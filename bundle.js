...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(29);
	var viewStates = __webpack_require__(39);
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://fast-citadel-82471.herokuapp.com'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayScoreTemplate = __webpack_require__(9);
	...
	var signOutFailure = function signOutFailure(error) {
	  var alertText = 'Status code ' + error.status + ' : ' + error.statusText;
	  $('.alert#error-message').append(alertText).show();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2 class=\"score\">\n  Welcome, "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.name : stack1), depth0))
	    + "! <br />\n  You have: $"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.score : stack1), depth0))
	    + "\n</h2>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeNewGameModal = function makeNewGameModal() {
	...
	var onValueClick = function onValueClick(event) {
	  event.preventDefault();
	  var clue_id = $(event.target).parent().attr('id');
	  // console.log(clue_id);
	  api.askQuestion(clue_id).done(ui.displayQuestion).fail(ui.failure);
	};

	var onAnswerSubmit = function onAnswerSubmit(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.submitAnswer(data).done(ui.answerSuccess).fail(ui.answerFailure);
	};

	var onBackCategories = function onBackCategories(event) {
	  event.preventDefault();
	  ui.displayCategories();
	};

	var onBackValues = function onBackValues(event) {
	  event.preventDefault();
	  ui.displayValues();
	};

	var onNextQuestion = function onNextQuestion(event) {
	  event.preventDefault();
	  api.updateBoard().done(ui.updateBoardSuccess).fail(ui.failure);
	};

	var onAllGames = function onAllGames(event) {
	  event.preventDefault();
	  api.getAllGames().done(ui.allGamesSuccess).fail(ui.failure);
	};

	var onResetScore = function onResetScore(event) {
	  event.preventDefault();
	  api.resetUserScore().done(ui.updateScoreSuccess).fail(ui.failure);
	};
	...
	var onCloseAllGames = function onCloseAllGames() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pickCategory = function pickCategory(cat_id) {
	  return $.ajax({
	...
	var askQuestion = function askQuestion(clue_id) {
	  return $.ajax({
	...
	var submitAnswer = function submitAnswer(data) {
	  return $.ajax({
	...
	var resetUserScore = function resetUserScore() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showGameTemplate = __webpack_require__(32);
	var showClueValues = __webpack_require__(33);
	var showQuestionTemplate = __webpack_require__(34);
	var showResponseTemplate = __webpack_require__(35);
	var showGameOverTemplate = __webpack_require__(36);
	var showScoreTemplate = __webpack_require__(37);
	var showAllGamesTemplate = __webpack_require__(38);
	...
	var filter_categories = function filter_categories(data) {
	  var categories = [];
	  var ids = [];
	...
	var sort_clues = function sort_clues() {
	  app.game.categories.forEach(function (category) {
	    console.log(category);
	    category.clues = category.clues.sort(function (a, b) {
	...
	var build_categories = function build_categories(data) {
	  data.forEach(function (element) {
	    app.game.categories.forEach(function (category) {
	...
	var valuesSuccess = function valuesSuccess(data) {
	...
	module.exports = {
	  ...
	  success: success,
	  signInSuccess: signInSuccess,
	  displayValues: displayValues, displayQuestion: displayQuestion,
	  answerSuccess: answerSuccess, answerFailure: answerFailure,
	  displayCategories: displayCategories, valuesSuccess: valuesSuccess,
	  updateBoardSuccess: updateBoardSuccess, updateScoreSuccess: updateScoreSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"category\">\n    <ul>\n      <h3 class=\"category-title\" id=\""
	    ...
	    + "</h3>\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"display-question-values","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "    </ul>\n  </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.unless.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.answered : depth0),{"name":"unless","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=container.escapeExpression;

	  return "      <li class=\"clue\" id=\""
	    + alias1(container.lambda((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n        <p class=\"value\">$"
	    + alias1(((helper = (helper = helpers.value || (depth0 != null ? depth0.value : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"value","hash":{},"data":data}) : helper)))
	    + "</p>\n        <div class=\"question\">\n        </div>\n        </p>\n      </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.clues : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"question-ask-box\">\n\n  <h2 class=\"category-title\">"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.clue : depth0)) != null ? stack1.category : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n\n  <h3 class=\"question\">For $"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.clue : depth0)) != null ? stack1.value : stack1), depth0))
	    + ": <br/>\n     "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.clue : depth0)) != null ? stack1.question : stack1), depth0))
	    + " </h3>\n</div>\n\n<form id=\"question-response\" class=\"question-response-box\">\n  <fieldset>\n    <legend>Who/What is...</legend>\n    <input type=\"text\" class=\"form-control\" name=\"clue[response]\" placeholder=\"Who/What is...\" id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.clue : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <input type=\"submit\" name=\"submit\" class=\"btn btn-success\" value=\"Answer!\">\n    <button class=\"btn btn-danger\" id=\"backToCategories\">Back</button>\n  </fieldset>\n</form>\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <p>Correct! The answer is "
	    + container.escapeExpression(((helper = (helper = helpers.clue_answer || (depth0 != null ? depth0.clue_answer : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"clue_answer","hash":{},"data":data}) : helper)))
	    + "</p>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "  Sorry, the correct answer is <em>"
	    + container.escapeExpression(((helper = (helper = helpers.clue_answer || (depth0 != null ? depth0.clue_answer : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"clue_answer","hash":{},"data":data}) : helper)))
	    + "</em>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.correct : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "<br />\n<br />\n\n<button class=\"btn btn-default\" id=\"nextQuestion\">Next Question!</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"game-over\">\n  <h1>Game over</h1>\n  <button type=\"button\" class=\"btn btn-default play-again-btn\">\n  Play again? </button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<p>You've played "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.games : depth0)) != null ? stack1.length : stack1), depth0))
	    + " games.</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// CHANGE PASSWORD
	var changePassView = function changePassView() {
